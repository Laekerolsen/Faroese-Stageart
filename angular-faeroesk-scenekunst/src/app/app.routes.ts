...
export const routes: Routes = [
  ...
  { path: 'betalt', canActivate: [AuthGuard], component: ConfirmationPageComponent, pathMatch: 'full', data: { permissions: ['haspayment'], redirecturl: '/ordrer', title: 'Bekræftelse - Færøsk Scenekunst', description: 'Bekræft din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, bekræftelse, viva, kasse' } },
