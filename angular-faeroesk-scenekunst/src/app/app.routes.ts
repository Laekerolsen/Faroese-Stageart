...
export const routes: Routes = [
  ...
  { path: 'kurv', canActivate: [AuthGuard], component: BasketPageComponent, pathMatch: 'full', data: { permissions: ['haslines'], redirecturl: '/', title: 'Indkøbskurv - Færøsk Scenekunst', description: 'Se din indkøbskurv og administrer dine varer før du går til kassen.', keywords: 'Færøsk Scenekunst, indkøbskurv, varer, kasse' } },
  { path: 'adresse', canActivate: [AuthGuard], component: AddressPageComponent, pathMatch: 'full', data: { permissions: ['isconfirmed', 'haslines'], redirecturl: '/kurv', title: 'Adresse - Færøsk Scenekunst', description: 'Se og rediger din adresse inden du går videre til betaling', keywords: 'Færøsk Scenekunst, adresse, betaling, kasse' } },
  { path: 'betaling', canActivate: [AuthGuard], component: PaymentPageComponent, pathMatch: 'full', data: { permissions: ['isconfirmed', 'hasaddress', 'haslines'], redirecturl: '/adresse', title: 'Betaling - Færøsk Scenekunst', description: 'Inspicer din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, betaling, viva, kasse' } },
  { path: 'betalt', canActivate: [AuthGuard], component: ConfirmationPageComponent, pathMatch: 'full', data: { permissions: ['haspayment'], redirecturl: '/betaling', title: 'Bekræftelse - Færøsk Scenekunst', description: 'Bekræft din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, bekræftelse, viva, kasse' } },
  { path: 'min-side', canActivate: [AuthGuard], component: OrdersListPageComponent, pathMatch: 'full', data: { permissions: ['hasaddresses'], redirecturl: '/', title: 'Dine ordrer - Færøsk Scenekunst', description: 'Bekræft din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, bekræftelse, viva, kasse' } },
  { path: 'ordrer', canActivate: [AuthGuard], component: OrdersListPageComponent, pathMatch: 'full', data: { permissions: ['hasorders'], redirecturl: '/', title: 'Dine ordrer - Færøsk Scenekunst', description: 'Bekræft din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, bekræftelse, viva, kasse' } },
  { path: 'ordre/:id', canActivate: [AuthGuard], component: OrderViewPageComponent, data: { permissions: ['hasorderid'], redirecturl: '/ordrer', title: 'Din ordre - Færøsk Scenekunst', description: 'Bekræft din ordre inden du går videre til betaling hos viva', keywords: 'Færøsk Scenekunst, ordre, bekræftelse, viva, kasse' } },
